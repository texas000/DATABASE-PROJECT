      ...
      for (i = 0; i < 21; i++) {
        ...
        dbRefObject.on('value', snap => {
          ...
          board.innerHTML =
            ...
            '</td><td>' +
            price +
            '</td></tr><td><a href="javascript:void(0);" onclick=\'shopping("' +
            nameCapitalized +
            '",' +
            pure_price +
            ')\'><i class="material-icons">add_circle</i></a></td>';
    ...
    while (startF < 100) {
      ...
      dbRefObject.on('value', snap => {
        ...
        board.innerHTML =
          ...
          '</td><td>' +
          price +
          '</td></tr><td><a href="javascript:void(0);" onclick="return shopping();"><i class="material-icons">add_circle</i></a></td>';
